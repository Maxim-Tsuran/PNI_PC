...
# Так же здесь обрабатываются данные для проверки работы модели катбуст и загружаются в папку test_with_mean_amplitude_and_defect и train_with_mean_amplitude_and_defect
